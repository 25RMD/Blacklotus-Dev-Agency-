  ...
  return (
    <html lang='en'>
      <head>
        ...
        />
        <link
          href='https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..900;1,6..96,400&family=Inter:wght@200..900&family=Poppins:wght@400;500;600;700;800;900&display=swap'
          rel='stylesheet'
        />
        <Meta />
        <Links />
