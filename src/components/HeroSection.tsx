...
export function HeroSection({ isLoaded = false }: HeroSectionProps) {
  ...
  const entranceOffset = useMotionValue(-window.innerHeight - 500)
  ...
  const scrollOffset = useTransform(scrollProgressSpring, [0, 1], ['0%', '-111%']) // 50vh / 45vh ≈ 111%
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black">
          <motion.video
            ...
            animate={isLoaded ? { opacity: 0.8, scale: 1 } : { opacity: 0, scale: 1.3 }}
          ...
          <div className="absolute bottom-8 left-6 md:left-12 max-w-4xl z-20 overflow-hidden">
            ...
            <div className="overflow-hidden">
              <motion.h2
                ...
                transition={{ duration: 1.4, ease: [0.16, 1, 0.3, 1], delay: 1.7 }}
        ...
        >
          ...
          >
            <motion.div
              ...
              animate={isLoaded ? { scale: 1, opacity: 1 } : { scale: 1.5, opacity: 0 }}
